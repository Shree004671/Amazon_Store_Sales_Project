...
Sum of Sales, Sum of Profit, Count of Order ID

# Step 6: Dashboard Development
Different visuals are added to represent the data clearly, including:
KPI cards, Donut charts, Bar charts, Line charts, Map visual, Slicers / filters
...
KPI cards, Bar charts, Donut charts, Line graph, Map chart, Slicers
